...
async function main() {
  const prenoticePath = path.join(__dirname, "output", "2026_FLP_사전고지_공지슬라이드_Carbon2x_SK.pptx");
  const debriefPath = path.join(__dirname, "output", "2026_FLP_디브리프_공지슬라이드_Carbon2x_SK.pptx");
