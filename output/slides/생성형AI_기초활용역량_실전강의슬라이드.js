...
function addBase(slide, index, section, dark = false) {
  ...
  slide.addShape(pptx.ShapeType.line, {
    ...
    w: 11.85,
    h: 0,
    line: { color: dark ? "557082" : C.line, width: 1 },
  });
}
...
function addCard(slide, cfg) {
  slide.addShape(pptx.ShapeType.roundRect, {
    ...
    shadow: cfg.shadow === false ? undefined : safeOuterShadow("20303C", 0.1, 45, 1, 1),
  });
  if (cfg.kicker) {
...
function addSectionBreak(slide, index, section, title, body) {
  ...
  slide.addText(
    title,
    textOpts(title, 1.34, 1.44, 6.05, 1.08, {
      fontSize: 30,
      minFontSize: 23,
      maxFontSize: 31,
      bold: true,
  ...
  slide.addText(
    body,
    textOpts(body, 1.38, 2.72, 5.8, 1.38, {
      fontSize: 15,
      minFontSize: 12,
      maxFontSize: 16,
      color: "DCE8EF",
...
function buildSlides() {
  ...
  slide = pptx.addSlide();
  addBase(slide, 1, "생성형 AI 기초활용역량", true);
  slide.addShape(pptx.ShapeType.rect, {
    x: 7.58,
    y: 0.95,
    w: 4.05,
    h: 5.28,
    line: { color: "456173", transparency: 100 },
    fill: { color: "294A5F", transparency: 0 },
  });
  slide.addShape(pptx.ShapeType.rect, {
    x: 7.86,
    y: 1.22,
    w: 3.5,
    h: 4.72,
    line: { color: "89A2AF", width: 1 },
    fill: { color: "365D74", transparency: 25 },
  });
  addPill(slide, "AI COLLABORATION", 1.22, 1.36, 1.7, C.gold, C.ink);
  slide.addText(
    "생성형 AI\n기초활용역량",
    textOpts("생성형 AI\n기초활용역량", 1.2, 1.92, 4.75, 1.22, {
      fontSize: 30,
      minFontSize: 24,
      maxFontSize: 32,
      bold: true,
  ...
  slide.addText(
    "목적을 분명히 하고\n질문하게 하고\n판단까지 가는 AI 협업",
    textOpts("목적을 분명히 하고\n질문하게 하고\n판단까지 가는 AI 협업", 1.24, 3.46, 4.45, 0.98, {
      fontSize: 16,
      minFontSize: 13,
      maxFontSize: 17,
      color: "DDE8EF",
  ...
  addCard(slide, {
    ...
    h: 0.92,
    kicker: "오늘의 약속",
    title: "기능보다 목적, 답변보다 질문, 초안보다 판단을 보겠습니다",
    fill: "21495F",
    line: "557B8E",
    kickerColor: "D2E0E7",
    titleColor: C.white,
